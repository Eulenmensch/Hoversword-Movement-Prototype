...
Shader "Unlit/Anime_"
{
	...
	SubShader
	{
		...
		{
			Gradient gradient4 = NewGradient( 0, 2, 2, float4( 1, 0.6745283, 0.7541892, 0.2205844 ), float4( 1, 0.1098039, 0.3501382, 0.2882429 ), 0, 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
...
/*ASEBEGIN
Version=18100
0;554;1920;465;3267.602;-695.348;1.656195;True;True
...
Node;AmplifyShaderEditor.GradientNode;4;-1004.218,-465.1019;Inherit;False;0;2;2;1,0.6745283,0.7541892,0.2205844;1,0.1098039,0.3501382,0.2882429;1,0;1,1;0;1;OBJECT;0
...
ASEEND*/
//CHKSM=E081FC2FD6038F7D8BC74E9833E6C712C6FAAA11