...
Shader "test"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 color12 = IsGammaSpace() ? float4(0.3333334,0.6211672,1,0) : float4(0.09084176,0.3438143,1,0);
			...
			float simplePerlin2D58 = snoise( temp_cast_1*4.55 );
			simplePerlin2D58 = simplePerlin2D58*0.5 + 0.5;
			float smoothstepResult60 = smoothstep( simplePerlin2D58 , 0.76 , 0.0);
			float mulTime25 = _Time.y * 0.5;
			float2 temp_cast_2 = (( 1.0 - mulTime25 )).xx;
			float2 uv_TexCoord36 = i.uv_texcoord + temp_cast_2;
			float2 temp_cast_3 = (( uv_TexCoord36.y % 0.54 )).xx;
			float simplePerlin2D53 = snoise( temp_cast_3 );
			simplePerlin2D53 = simplePerlin2D53*0.5 + 0.5;
			float smoothstepResult57 = smoothstep( 0.11 , 0.8 , simplePerlin2D53);
...
/*ASEBEGIN
Version=18100
2700;281;2420;1108;750.5372;128.215;1;True;True
Node;AmplifyShaderEditor.Vector2Node;48;-3215.899,630.8685;Inherit;True;Constant;_Vector0;Vector 0;1;0;Create;True;0;0;False;0;False;0.7,4.58;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SimpleTimeNode;25;-1455.86,889.9374;Inherit;False;1;0;FLOAT;0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.VoronoiNode;1;-1030.118,-136.2415;Inherit;True;0;3;1;3;1;False;1;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;5.92;False;3;FLOAT;0;False;2;FLOAT;0;FLOAT2;1
...
Node;AmplifyShaderEditor.OneMinusNode;70;-1217.197,914.5583;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.NoiseGeneratorNode;58;-170.2277,360.5679;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;4.55;False;1;FLOAT;0
Node;AmplifyShaderEditor.SmoothstepOpNode;60;82.77234,375.5679;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0.62;False;2;FLOAT;0.76;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.NoiseGeneratorNode;53;-26.88715,882.2804;Inherit;True;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SmoothstepOpNode;57;363.1127,720.447;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0.11;False;2;FLOAT;0.8;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;12;359.6361,-230.9819;Inherit;False;Constant;_Color0;Color 0;1;0;Create;True;0;0;False;0;False;0.3333334,0.6211672,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=DE47D711398A8EC6747517109B1B3CBB345D5E6D