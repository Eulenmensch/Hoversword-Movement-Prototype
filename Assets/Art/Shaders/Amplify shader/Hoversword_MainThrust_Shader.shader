...
Shader "ParticleSystems_Shader"
{
	...
	SubShader
	{
		...
		{
			float4 color53 = IsGammaSpace() ? float4(0,1,0.9903989,0) : float4(0,1,0.9782977,0);
			...
			o.Alpha = 1;
			float4 appendResult46 = (float4(_MaskSpeed , 0.0 , 0.0 , 0.0));
			float2 panner45 = ( 1.0 * _Time.y * appendResult46.xy + ( _MaskScale * i.uv_texcoord ));
			float4 appendResult61 = (float4(_Mask02Speed , 0.0 , 0.0 , 0.0));
			...
			float2 uv_TexCoord65 = i.uv_texcoord + float2( 1,1 );
			float2 panner69 = ( 1.0 * _Time.y * appendResult68.xy + ( _Mask03Scale * uv_TexCoord65 ));
			float4 appendResult74 = (float4(0.0 , _Mask04Speed , 0.0 , 0.0));
			float2 panner75 = ( 1.0 * _Time.y * appendResult74.xy + ( _Mask04Scale * i.uv_texcoord ));
			clip( ( tex2D( _Mask01, panner45 ) * tex2D( _Mask02, panner62 ) * tex2D( _Mask03, panner69 ) * tex2D( _Mask04, panner75 ) ).r - _Cutoff );
		}
...
/*ASEBEGIN
Version=18100
0;586;1920;433;1849.429;1364.952;3.210866;True;True
Node;AmplifyShaderEditor.RangedFloatNode;40;723.5294,-1047.876;Inherit;False;Property;_TextureScale;Texture Scale;8;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;56;762.5977,9.902287;Inherit;False;Property;_Mask02Scale;Mask02 Scale;12;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;48;740.3347,-507.9109;Inherit;False;Property;_MaskScale;Mask Scale;9;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;44;721.3813,-1140.922;Inherit;False;Property;_TextureSpeed;Texture Speed;13;0;Create;True;0;0;False;0;False;1;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;72;713.0995,1122.479;Inherit;False;Property;_Mask04Scale;Mask04 Scale;10;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;64;732.4659,564.6647;Inherit;False;Property;_Mask03Scale;Mask03 Scale;11;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;65;706.1671,681.7814;Inherit;True;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;1,1;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;67;1026.589,760.4439;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;59;1508.858,-51.5556;Inherit;True;Property;_Mask02;Mask02;5;0;Create;True;0;0;False;0;False;-1;None;00f3233d580705b478879ead29b574fb;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;63;1518.336,200.3609;Inherit;True;Property;_Mask03;Mask03;7;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;37;1507.471,-313.0159;Inherit;True;Property;_Mask01;Mask01;4;0;Create;True;0;0;False;0;False;-1;None;5f0d9968d94ba5340955034a432da961;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;76;1498.97,758.1752;Inherit;True;Property;_Mask04;Mask04;6;0;Create;True;0;0;False;0;False;-1;None;f2f428276fc32464b948c138292a1242;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;39;1395.958,-1036.275;Inherit;True;Property;_MainTexture;MainTexture;19;0;Create;True;0;0;False;0;False;-1;None;af6114f3a6ec82b41a21b599c7c81dc1;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;55;1543.086,-814.3068;Inherit;False;Property;_Emission;Emission ;14;0;Create;True;0;0;False;0;False;1;8;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;53;1484.064,-1235.67;Inherit;False;Constant;_Color2;Color 2;10;0;Create;True;0;0;False;0;False;0,1,0.9903989,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;2187.699,-619.3134;Float;False;True;-1;2;;0;0;Unlit;ParticleSystems_Shader;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Off;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.2;True;False;0;True;Transparent;;Geometry;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;False;2;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;0;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=AB6CE6461B7813157698DB339C5050612E1B9C2A