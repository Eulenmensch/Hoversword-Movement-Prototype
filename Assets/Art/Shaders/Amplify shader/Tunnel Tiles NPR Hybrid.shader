...
Shader "Tunnel Tiles NPR Hybrid"
{
	Properties
	{
		...
		_AlbedoBrightness("Albedo Brightness", Float) = 1
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 blendOpSrc10 = SampleGradient( gradient9, ( _AlbedoBrightness * tex2DNode1.r ) );
			...
			float4 lerpResult48 = lerp( Albedo15 , _ShadowColor , LightAttenuationGradient32);
			...
			float div41=256.0/float(_PosterizeSteps);
			float4 posterize41 = ( floor( Albedo15 * div41 ) / div41 );
			float4 lerpResult34 = lerp( _GradientKey01 , _GradientKey02 , saturate( (ase_worldPos.y*_LightGradientScale + _LightGradientOffset) ));
			float4 NPREmissive43 = ( posterize41 * ( LightAttenuationGradient32 * lerpResult34 * _LightGradientIntensity ) );
...
/*ASEBEGIN
Version=18100
-1920;12;1920;1017;2110.141;579.0448;1;True;False
Node;AmplifyShaderEditor.CommentaryNode;20;-1666,-562;Inherit;False;1378;729;PBR;16;7;1;3;6;2;5;4;10;12;9;8;15;13;17;50;51;PBR;1,1,1,1;0;0
Node;AmplifyShaderEditor.TexturePropertyNode;7;-1616,-256;Inherit;True;Property;_MainTexture;Main Texture;0;0;Create;True;0;0;False;0;False;714974d831a7a8c468e7e2a80bf7466d;9835c7487dd40fc4184079715a311f23;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.RangedFloatNode;51;-1440,-416;Inherit;False;Property;_AlbedoBrightness;Albedo Brightness;1;0;Create;True;0;0;False;0;False;1;331.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;50;-1216,-416;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;27;-1616,1264;Inherit;False;Property;_LightGradientOffset;Light Gradient Offset;8;0;Create;True;0;0;False;0;False;0;0.04;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;24;-1616,1184;Inherit;False;Property;_LightGradientScale;Light Gradient Scale;9;0;Create;True;0;0;False;0;False;0;0.04;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;33;-1360,768;Inherit;False;Property;_GradientKey01;GradientKey01;5;0;Create;True;0;0;False;0;False;0,0,0,0;0.643,0.467461,0.467461,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;31;-1184,1120;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;30;-1360,944;Inherit;False;Property;_GradientKey02;GradientKey02;6;0;Create;True;0;0;False;0;False;0,0,0,0;0.8784314,0.8784314,0.8784314,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;6;-1072,-64;Inherit;False;Property;_Smoothness;Smoothness;3;0;Create;True;0;0;False;0;False;1;0.38;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;3;-1264,32;Inherit;False;Property;_NormalStrength;Normal Strength;2;0;Create;True;0;0;False;0;False;1;0.92;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;39;-800,896;Inherit;False;Property;_PosterizeSteps;PosterizeSteps;10;0;Create;True;0;0;False;0;False;0;14;0;1;INT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;35;-1008,1200;Inherit;False;Property;_LightGradientIntensity;Light Gradient Intensity;7;0;Create;True;0;0;False;0;False;0;4.08;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;45;-192,-80;Inherit;False;Property;_ShadowColor;Shadow Color;4;0;Create;True;0;0;False;0;False;0.1132075,0.1132075,0.1132075,0;0.3055258,0.2647739,0.3207547,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=EE8F61BBC15C963E5361CD261D16718B6FB7B7F5